...
namespace Calendar
{
    class Calenda
    {
        ...
        public static Queue<CalendarWeek<Calenda>> weekQueue = new Queue<CalendarWeek<Calenda>>();
        ...
        public void GetCalendar()
        {
            ...
            {
                CalendarWeek<Calenda> cal = new CalendarWeek<Calenda>();
                for (int j = 0; j < calendar.GetLength(1) && currentDay - dayOfWeek + 1 <= days; j++)
                {
                    ...
                    else
                    {
                        ...
                        CalendarWeek<Calenda> calenderObjects = new CalendarWeek<Calenda>(calendar[i, j]);
